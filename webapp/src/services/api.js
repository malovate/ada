...
// BACKEND_URL switches automatically between local and production.
// Vite exposes environment variables that start with 'VITE_' to the app.
// In development (npm run dev): VITE_BACKEND_URL is not set, so we
//   fall back to localhost:5000 — your local Python server.
// In production (after deploying): we set VITE_BACKEND_URL in a
//   .env.production file to your Railway URL.
//
// import.meta.env is Vite's way of reading environment variables.
// It's the Vite equivalent of Python's os.getenv().
